...
//        try context.fetch(FetchDescriptor<Response>(predicate: #Predicate { $0.id == id })).first
//    }
//    
//    func fetchFavorites() throws -> [Response] {
//        try context.fetch(FetchDescriptor<Response>(predicate: #Predicate { $0.isFavorite }))
//    }
//}
